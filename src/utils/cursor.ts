...
export type RotateCursorType = 'nwse-rotate' | 'nesw-rotate' | 'senw-rotate' | 'swne-rotate'
...
function getCursorCss(svgContent: string, rotation: number = 0, flipX: boolean = false, color: string = '#000'): string {
  const r = rotation
...
// Corner handle to cursor type mapping
...
export function getRotateCursor(corner: string, options: CursorOptions = {}): string {
